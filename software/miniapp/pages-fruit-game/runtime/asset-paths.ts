...
FRUIT_GAME_ASSETS = {
  orchard: {
    day: new URL('../static/backgrounds/orchard-day.jpg', import.meta.url).href,
    sunset: new URL('../static/backgrounds/orchard-sunset.jpg', import.meta.url).href,
    basketZone: new URL('../static/backgrounds/basket-zone.jpg', import.meta.url).href
  },
  character: {
  ...
  basket: {
    empty: new URL('../static/basket/empty.png', import.meta.url).href,
    half: new URL('../static/basket/half.png', import.meta.url).href,
    full: new URL('../static/basket/full.png', import.meta.url).href
  },
  effects: {
...
FRUIT_GAME_ASSETS = {
  orchard: {
    day: `${RFG_STATIC_ROOT}/backgrounds/orchard-day.jpg`,
    sunset: `${RFG_STATIC_ROOT}/backgrounds/orchard-sunset.jpg`,
    basketZone: `${RFG_STATIC_ROOT}/backgrounds/basket-zone.jpg`
  },
  character: {
  ...
  basket: {
    empty: `${RFG_STATIC_ROOT}/basket/empty.png`,
    half: `${RFG_STATIC_ROOT}/basket/half.png`,
    full: `${RFG_STATIC_ROOT}/basket/full.png`
  },
  effects: {
