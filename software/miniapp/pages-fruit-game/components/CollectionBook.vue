...
/* Fixed logical-stage collection layout. */
.rfg-collection__panel { width: 920px; height: 560px; padding: 18px 26px 12px; }
.rfg-collection__title { font-size: 36px; }
.rfg-collection__subtitle { font-size: 14px; }
.rfg-collection__summary { gap: 18px; font-size: 15px; }
.rfg-collection__grid { gap: 11px; padding: 10px 3px; }
.rfg-collection__item { padding: 5px 4px 6px; }
.rfg-collection__fruit { width: 74px; height: 74px; }
.rfg-collection__name { font-size: 12px; }
.rfg-collection__back { width: 180px; margin-top: 5px; font-size: 20px; line-height: 1.9; }
</style>
