...
/* Fixed logical-stage metrics; the parent stage performs all device scaling. */
.rfg-hud { left: var(--game-safe-left, 12px); right: var(--game-safe-right, 12px); gap: 10px; }
.rfg-hud__metric { flex-basis: 20%; min-width: 0; height: 44px; padding: 4px 8px; gap: 8px; }
.rfg-hud__label, .rfg-hud__angle { font-size: 15px; }
.rfg-hud__value { font-size: 25px; }
.rfg-hud__score-row { gap: 14px; font-size: 15px; }
.rfg-hud__progress-text { font-size: 13px; }
.rfg-hud__pause { flex-basis: 44px; width: 44px; height: 44px; line-height: 38px; }
.rfg-hud__exit { flex-basis: 62px; width: 62px; height: 44px; line-height: 38px; }
</style>
