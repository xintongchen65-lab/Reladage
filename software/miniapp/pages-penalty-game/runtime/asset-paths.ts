...
// #ifdef H5
PENALTY_ASSETS = {
  stadium:new URL('../static/backgrounds/stadium.jpg',import.meta.url).href,
...
PENALTY_ASSETS={stadium:`${root}/backgrounds/stadium.jpg`,player:{neutral:`${root}/player/neutral.png`,leftFlex:`${root}/player/left-flex.png`,leftKick:`${root}/player/left-kick.png`,rightFlex:`${root}/player/right-flex.png`,rightKick:`${root}/player/right-kick.png`},keeper:{ready:`${root}/keeper/ready.png`,left:`${root}/keeper/dive-left.png`,right:`${root}/keeper/dive-right.png`},ball:`${root}/objects/ball.png`,effects:{goal:`${root}/effects/goal.png`,save:`${root}/effects/save.png`,miss:`${root}/effects/miss.png`,combo:`${root}/effects/combo.png`}}
// #endif
