<template>
  <view class="mg-game">
    <view class="mg-game__viewport" :style="stageCss">
...
import { GAME_DESIGN_HEIGHT, GAME_DESIGN_WIDTH, gameStageStyle, getViewportLayout } from '../../game-platform/runtime/viewport'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      stageSize: { width: GAME_DESIGN_WIDTH, height: GAME_DESIGN_HEIGHT },
  ...
  computed: {
    stageCss(): Record<string, string> {
      return gameStageStyle(this.viewport, '--mg-safe-top')
    },
    currentCount(): number {
...
.mg-game__title-sign{left:1.5%;top:72px;top:calc(var(--mg-safe-top,8px) + clamp(48px,9.2vh,66px) + 3px);width:118px;width:clamp(118px,16vw,196px);height:56px;height:clamp(56px,11vh,90px);padding:0;border:0;border-radius:0;background:none;box-shadow:none;transform:none;filter:drop-shadow(0 5px 5px rgba(74,48,19,.2))}
.mg-game__arena{inset:0}
.mg-game__lane{width:112px;width:clamp(112px,15.2vw,174px);height:100px;height:clamp(100px,25vh,164px)}
...
@media(max-height:420px){.mg-game__arena{inset:0}.mg-game__lane{width:104px;width:clamp(104px,15vw,146px);height:94px;height:clamp(94px,24vh,136px)}}

/* Shared 1280x720 stage overrides. */
.mg-game__title-sign { top: calc(var(--mg-safe-top, 8px) + 69px); width: 196px; height: 79px; }
.mg-game__title-sign text { font-size: 22px; }
.mg-game__hud { left: var(--game-safe-left, 12px); right: var(--game-safe-right, 12px); height: 66px; gap: 10px; padding: 7px 10px 7px 16px; }
.mg-game__progress-title { font-size: 16px; }
.mg-game__room-strip { top: calc(var(--mg-safe-top, 8px) + 74px); }
.mg-game__arena { inset: 0; }
.mg-game__lane { width: 174px; height: 164px; }
.mg-game__hammer { width: 113px; height: 130px; }
.mg-game__hit-burst { width: 166px; height: 137px; }
.mg-game__status-card { width: 270px; padding: 9px 12px; }
.mg-game__motion-track { height: 52px; }
.mg-game__status-stage { font-size: 28px; }
.mg-game__prompt { bottom: 3.4%; max-width: 614px; padding: 9px 18px; font-size: 18px; }
.mg-game__score-card { bottom: 2.4%; padding: 7px; }
.mg-game__overlay-card { width: 430px; max-width: 430px; }
</style>
