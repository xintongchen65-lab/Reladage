...
namespace rehab {
class BoxSquatDetector final : public RuleBasedDetector {
public:
  BoxSquatDetector();
protected:
  ...
  uint32_t minimumRepDurationMs() const override { return 1300; }
  uint32_t maximumRepDurationMs() const override { return 14000; }
};
}
