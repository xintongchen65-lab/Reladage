...
namespace rehab {
class ScaptionRaiseDetector final : public RuleBasedDetector {
public:
  ScaptionRaiseDetector();
protected:
  ...
  uint32_t minimumRepDurationMs() const override { return 900; }
  uint32_t maximumRepDurationMs() const override { return 12000; }
};
}
